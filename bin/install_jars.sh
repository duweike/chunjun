...
##kafka-confluent
mvn install:install-file -DgroupId=io.confluent -DartifactId=kafka-schema-registry-client -Dversion=6.2.2 -Dpackaging=jar -Dfile=../jars/kafka-schema-registry-client-6.2.2.jar
